...
class SpeakerIdentifier:
    ...
    def _handle_single_speaker(self, speaker_id: str, parsed_data: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
    ...
    def _identify_two_speakers(self, speakers: List[str], parsed_data: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
        ...
        if not speaker1_has_segments and not speaker2_has_segments:
            self.logger.warning("Both speakers have no segments; assigning UNKNOWN to both speakers.")
            ...
            for speaker_id, speaker_segs in (
                ...
                scores = self._calculate_speaker_scores(speaker_segs, speaker_id == first_speaker)
    ...
    def _identify_multiple_speakers(
        self, speakers: List[str], parsed_data: Dict[str, Any]
    ...
    def _calculate_speaker_scores(self, segments: List[Dict[str, Any]], is_first_speaker: bool) -> Dict[str, Any]:
