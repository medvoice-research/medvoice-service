...
import pytest
from app.services.transcription_transformer import (
...
class TestTranscriptionTransformer:
    ...
    def test_transform_with_consultation_metadata(self, transformer, sample_whisperx_result):
        ...
        result = transformer.transform(
            sample_whisperx_result,
            consultation_metadata=consultation_meta
        )
    ...
    def test_transform_with_overrides(self, transformer, sample_whisperx_result):
        ...
        result = transformer.transform_with_overrides(
            sample_whisperx_result,
            manual_mapping
        )
    ...
    def test_empty_result_creation(self, transformer):
        ...
        no_speakers = {
            "segments": [
                {"start": 0.0, "end": 1.0, "text": "Test", "words": []}
            ],
            "word_segments": []
        }
