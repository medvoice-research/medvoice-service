...
class TestFilenameUtils:
    ...
    def test_generate_workflow_result_filename(self):
        ...
        filename = generate_workflow_result_filename("whisperx-workflow-abc123def456")
    ...
    def test_generate_workflow_result_filename_custom_extension(self):
        ...
        filename = generate_workflow_result_filename("whisperx-workflow-123", extension=".txt")
