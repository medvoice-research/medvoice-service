...
with search_col:
    search_workflow_id = st.text_input(
        ...
        placeholder="whisperx-wf-pt_abc12345-...",
        help="Enter full or partial workflow ID"
    )
        ...
        if status == "COMPLETED":
            with st.expander("📄 View Results", expanded=False):
                try:
                    ...
                    tab1, tab2, tab3, tab4 = st.tabs(["📝 Transcript", "🏥 Medical Entities", "📋 SOAP Note", "📊 Raw JSON"])
